...
|-------|----------|------------|---------|
| Act 1 | 1-X | [Major events] | ☐ |
| Act 2 | X-Y | [Major events] | ☐ |
| Act 3 | Y-Z | [Major events] | ☐ |
...
|--------|---------|---------|------------------|---------|
| [Name] | [Type] | [Type] | [What's special] | ☐ Detailed |
...
|------|------|------------|------------------|-----------|
| [Name] | [Village/Town/City] | [Number] | [What's special] | ☐ |

## Points of Interest
### Adventure Sites
| Location | Type | Danger | Hook | Mapped? |
|----------|------|---------|------|---------|
| [Name] | [Dungeon/Ruin/etc] | [Level] | [Why go there] | ☐ |
...
## Module Concept Card
**Module Question:** [What will be answered by module's end?]
**Stakes:** 
- Success means: [Positive outcome]
- Failure means: [Negative outcome]
**Tone:** [How does this differ from previous module?]
**Campaign Connection:** [How this advances the Big Three]
...
**Defeat Conditions:** 
- Combat: [How to defeat through force]
- Social: [How to defeat through negotiation]
- Clever: [How to defeat through trickery]

### Supporting Cast
| Name | Role | Offers PCs | Wants in Return | Location |
|------|------|------------|-----------------|----------|
| [Name] | [Role] | [Help type] | [Payment] | [Where found] |
| [Name] | [Role] | [Help type] | [Payment] | [Where found] |

## Key Locations
### Hub: [Location Name]
**Purpose:** [Safe rest/resupply]
**Key NPCs:** [Who's here]
**Services:** [What's available]
**Future Hooks:** [Seeds for later]

### Adventure Site 1: [Location Name]
**Purpose:** [Why PCs go here]
**Challenge:** [What opposes them]
**Secrets:** [What's hidden]
**Approaches:** [Multiple ways in/out]

### Adventure Site 2: [Location Name]
**Purpose:** [Why PCs go here]
**Challenge:** [What opposes them]
**Secrets:** [What's hidden]
**Approaches:** [Multiple ways in/out]
...
## Information Flow
### Essential Clues (PCs must learn these)
1. **[Clue]:** 
   - Found via [method 1]
   - Found via [method 2]
   - Found via [method 3]
...
- **[Character Name]'s Secret:** [Personal revelation]
- **Campaign Foreshadowing:** [Future module hint]
- **Tactical Advantage:** [Helpful for confrontation]

## Contingency Planning
### If Players Solve Too Quickly
- Add complication: [What goes wrong]
- Introduce rival: [Who else wants the prize]

### If Players Get Stuck
- Helpful NPC: [Who appears with hints]
- Environmental clue: [What becomes obvious]

### If Players Avoid Conflict
- Escalation: [How things get worse]
- Innocent in danger: [Who needs help]

## Transition Planning
### How This Module Might End
- **Best Case:** [Victory outcome]
- **Worst Case:** [Failure outcome]  
- **Likely Case:** [Partial success]

### Seeds for Next Module
- **Immediate Hook:** [Discovered in finale]
- **Slow Burn:** [Background development]
- **Character Hook:** [Personal connection]

## Module Checklist
### Pre-Module
- [ ] Concept card complete
- [ ] Session breakdown finished
- [ ] NPCs have motivations
- [ ] Locations have maps/sketches
- [ ] Clues have redundancy
- [ ] Handouts prepared
...
**Structure:** [e.g., Setup → Conflict → Cliffhanger]
...
**Ending Type:** ☐ Cliffhanger ☐ Natural Break ☐ Energy Flag ☐ Time Limit
**Satisfaction:** ☐☐☐☐☐ (1-5)
