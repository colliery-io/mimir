...
use crate::models::campaign::template_documents::{NewTemplateDocument, TemplateDocument, UpdateTemplateDocument};
...
impl TemplateRepository {
    ...
    pub fn update(
        ...
        // Create new content
        let new_content = updates.document_content.clone().unwrap_or(latest.document_content.clone());
