...
fn seed_test_monster_data(conn: &mut SqliteConnection) {
    ...
    let monsters = vec![
        ("Goblin", "S", "Humanoid", "Neutral Evil", "1/4", 0.25, 7, 15, "MM", r#"{"name":"Goblin","source":"MM","size":["S"],"type":"humanoid","alignment":["N","E"],"ac":[{"ac":15}],"hp":{"average":7},"cr":"1/4"}"#),
        ("Orc", "M", "Humanoid", "Chaotic Evil", "1/2", 0.5, 15, 13, "MM", r#"{"name":"Orc","source":"MM","size":["M"],"type":"humanoid","alignment":["C","E"],"ac":[{"ac":13}],"hp":{"average":15},"cr":"1/2"}"#),
        ("Skeleton", "M", "Undead", "Lawful Evil", "1/4", 0.25, 13, 13, "MM", r#"{"name":"Skeleton","source":"MM","size":["M"],"type":"undead","alignment":["L","E"],"ac":[{"ac":13}],"hp":{"average":13},"cr":"1/4"}"#),
        ("Zombie", "M", "Undead", "Neutral Evil", "1/4", 0.25, 22, 8, "MM", r#"{"name":"Zombie","source":"MM","size":["M"],"type":"undead","alignment":["N","E"],"ac":[{"ac":8}],"hp":{"average":22},"cr":"1/4"}"#),
        ("Owlbear", "L", "Monstrosity", "Unaligned", "3", 3.0, 59, 13, "MM", r#"{"name":"Owlbear","source":"MM","size":["L"],"type":"monstrosity","alignment":["U"],"ac":[{"ac":13}],"hp":{"average":59},"cr":"3"}"#),
        ("Troll", "L", "Giant", "Chaotic Evil", "5", 5.0, 84, 15, "MM", r#"{"name":"Troll","source":"MM","size":["L"],"type":"giant","alignment":["C","E"],"ac":[{"ac":15}],"hp":{"average":84},"cr":"5"}"#),
        ("Hill Giant", "H", "Giant", "Chaotic Evil", "5", 5.0, 105, 13, "MM", r#"{"name":"Hill Giant","source":"MM","size":["H"],"type":"giant","alignment":["C","E"],"ac":[{"ac":13}],"hp":{"average":105},"cr":"5"}"#),
        ("Young Red Dragon", "L", "Dragon", "Chaotic Evil", "10", 10.0, 178, 18, "MM", r#"{"name":"Young Red Dragon","source":"MM","size":["L"],"type":"dragon","alignment":["C","E"],"ac":[{"ac":18}],"hp":{"average":178},"cr":"10"}"#),
        ("Adult Red Dragon", "H", "Dragon", "Chaotic Evil", "17", 17.0, 256, 19, "MM", r#"{"name":"Adult Red Dragon","source":"MM","size":["H"],"type":"dragon","alignment":["C","E"],"ac":[{"ac":19}],"hp":{"average":256},"cr":"17"}"#),
        ("Lich", "M", "Undead", "Any Evil", "21", 21.0, 135, 17, "MM", r#"{"name":"Lich","source":"MM","size":["M"],"type":"undead","alignment":["A","E"],"ac":[{"ac":17}],"hp":{"average":135},"cr":"21"}"#),
        ("Bandit", "M", "Humanoid", "Any Non-lawful", "1/8", 0.125, 11, 12, "VRGR", r#"{"name":"Bandit","source":"VRGR","size":["M"],"type":"humanoid","alignment":["A","NX","L"],"ac":[{"ac":12}],"hp":{"average":11},"cr":"1/8"}"#),
        ("Vampire Spawn", "M", "Undead", "Neutral Evil", "5", 5.0, 82, 15, "VRGR", r#"{"name":"Vampire Spawn","source":"VRGR","size":["M"],"type":"undead","alignment":["N","E"],"ac":[{"ac":15}],"hp":{"average":82},"cr":"5"}"#),
    ];
...
fn test_search_monsters_no_filters() {
    ...
    let results = service.search_monsters(filters)
...
fn test_get_monster_by_name_and_source() {
    ...
    let monster = service.get_monster_by_name_and_source("Goblin", "MM")
...
fn test_get_monster_by_name_and_source_not_found() {
    ...
    let monster = service.get_monster_by_name_and_source("Nonexistent", "MM")
...
fn test_get_all_creature_types() {
    ...
    let types = service.get_all_creature_types()
...
fn test_get_cr_range() {
    ...
    let (min_cr, max_cr) = service.get_cr_range()
        .expect("Should get CR range");
...
fn test_get_monster_count_by_source() {
    ...
    let counts = service.get_monster_count_by_source()
