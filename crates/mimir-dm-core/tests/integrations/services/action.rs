...
fn test_search_actions_no_filters() {
    ...
    let results = ActionService::search_actions(&mut conn, filters).expect("Search should succeed");
...
fn test_get_action_by_id() {
    ...
    let action = ActionService::get_action_by_id(&mut conn, action_id).expect("Should get action");
...
fn test_get_action_by_id_not_found() {
    ...
    let action = ActionService::get_action_by_id(&mut conn, 99999).expect("Should not error");
...
fn test_get_time_types() {
    ...
    let types = ActionService::get_time_types(&mut conn).expect("Should get time types");
...
fn test_get_sources() {
    ...
    let sources = ActionService::get_sources(&mut conn).expect("Should get sources");
...
fn test_get_action_count() {
    ...
    let count = ActionService::get_action_count(&mut conn).expect("Should get count");
