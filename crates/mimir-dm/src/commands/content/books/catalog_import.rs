...
pub fn import_all_catalogs_from_book(
    ...
    match ConditionService::import_conditions_from_book(conn, book_dir, book_id) {
        Ok(condition_count) => {
            info!("Imported {} conditions from book '{}'", condition_count, book_id);
        }
        Err(e) => {
    ...
    match LanguageService::import_languages_from_book(conn, book_dir, book_id) {
        Ok(language_count) => {
            info!("Imported {} languages from book '{}'", language_count, book_id);
        }
        Err(e) => {
    ...
    match BackgroundService::import_backgrounds_from_book(conn, book_dir, book_id) {
        Ok(background_count) => {
            info!("Imported {} backgrounds from book '{}'", background_count, book_id);
        }
        Err(e) => {
    ...
    match TrapService::import_traps_from_book(conn, book_dir, book_id) {
        Ok(trap_count) => {
            info!("Imported {} traps/hazards from book '{}'", trap_count, book_id);
        }
        Err(e) => {
    ...
    match CultService::import_cults_from_book(conn, book_dir, book_id) {
        Ok(cult_count) => {
            info!("Imported {} cults/boons from book '{}'", cult_count, book_id);
        }
        Err(e) => {
    ...
    match VariantRuleService::import_variant_rules_from_book(conn, book_dir, book_id) {
        Ok(variant_rule_count) => {
            info!("Imported {} variant rules from book '{}'", variant_rule_count, book_id);
        }
        Err(e) => {
    ...
    match OptionalFeatureService::import_optional_features_from_book(conn, book_dir, book_id) {
        Ok(optional_feature_count) => {
            info!("Imported {} optional features from book '{}'", optional_feature_count, book_id);
        }
        Err(e) => {
    ...
    match MonsterService::import_monsters_from_book(conn, book_dir, book_id) {
        Ok(monster_count) => {
            info!("Imported {} monsters from book '{}'", monster_count, book_id);
        }
        Err(e) => {
    ...
    match VehicleService::import_vehicles_from_book(conn, book_dir, book_id) {
        Ok(vehicle_count) => {
            info!("Imported {} vehicles from book '{}'", vehicle_count, book_id);
        }
        Err(e) => {
