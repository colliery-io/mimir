  ...
  <table class="catalog-table">
    <thead>
      <tr>
        ...
        <th class="col-cr sortable" @click="$emit('sort', 'cr_numeric')">
          CR {{ sortIndicator('cr_numeric') }}
        </th>
...
const sortedMonsters = computed(() => {
  ...
  // Apply sorting
  if (['name', 'cr_numeric', 'source'].includes(props.sortColumn)) {
    filtered.sort((a, b) => {
      if (props.sortColumn === 'cr_numeric') {
        const comparison = a.cr_numeric - b.cr_numeric
